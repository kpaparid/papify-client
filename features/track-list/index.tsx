        ...
        <div className="flex flex-col items-center md:flex-row">
          <div className="relative size-52">
            <div className="relative h-full w-full cursor-pointer group" onClick={toggleYoutubePlayer}>
              <Image
                loading="lazy"
                src={item.image || "/placeholder.svg?height=300&width=300" || "/placeholder.svg"}
                alt={item.title}
                fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 space-x-6">
              ...
              {meta.youtube.length > 0 && (
                <div>
                  ...
                  <div className="text-sm text-muted-foreground mt-0.5 line-clamp-1">{meta.youtube[0].title}</div>
                  <div className="text-sm text-muted-foreground line-clamp-2">{formatDate(meta.youtube[0].publish_date, "dd.MM.yyyy")}</div>
                </div>
              )}
            </div>
            <div className="mt-3">
                      ...
                      <Badge asChild key={`${collection}-${index}`}>
                        <Button
                          className={cn(
                            ...
                            meta.collectionIds.includes(collection) ? "bg-[#183D3D] hover:brightness-75" : "bg-accent/75 opacity-50 hover:opacity-100"
                          )}
                        >
                          {collection}
                        </Button>
