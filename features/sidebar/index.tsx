"use client"
import { BsCollectionPlayFill, BsFolder, BsFolderFill } from "react-icons/bs"
...
export function Sidebar({
  ...
  return (
    <div className='w-[230px]'>
      <div className='h-screen w-[230px] sticky top-0 bfg-card backdrop-blur-md border-r border-accent'>
        ...
        <div className='px-3 py-10'>
          <div className='mb-6'>
            ...
            <div className='space-y-1'>
              ...
              <nav>
                <NavItem
                  href='/categories'
                  icon={<BsFolderFill className='size-[18px]' />}
          ...
          <div className='mb-6'>
            ...
            <nav className='space-y-1'>
              ...
              <NavItem
                href='/import'
                icon={<FaUpload className='size-[18px]' />}
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active
          ? "bg-accent/75 text-accent-foreground border border-accent"
          : "text-foreground hover:bg-accent/75 hover:text-accent-foreground border-transparent hover:border-accent border"
      )}
    >
      <span
